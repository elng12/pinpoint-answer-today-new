...
export const puzzleSeoTemplateVersionSchema = z.enum(["serp-v1", "serp-v2"]);
export const puzzleContentTemplateVersionSchema = z.enum(["evidence-v1"]);
...
export const puzzleRegistryEntrySchema = z.object({
  ...
  seoTemplateVersion: puzzleSeoTemplateVersionSchema.optional(),
  contentTemplateVersion: puzzleContentTemplateVersionSchema.optional(),
...
export const puzzleWrongGuessCandidateSchema = z.object({
  label: z.string().min(1),
  whyPlausible: z.string().min(1),
  whyRejected: z.string().min(1).optional(),
});
...
export const puzzleDetailContentSchema = z.object({
  ...
  wrongGuessCandidates: z.array(puzzleWrongGuessCandidateSchema).optional(),
  setValidationSummary: z.string().min(1).optional(),
  categoryPrecisionNote: z.string().min(1).optional(),
